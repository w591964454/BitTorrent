...
#define SENDBITFIELD	2	//表明已处于发送位图状态
#define RECVBITFIELD	3	//表明处于已接受位图状态
#define DATA			4	//表明处于与peer交换数据的状态
#define CLOSING			5	//表明处于即将与peer断开的状态

//发送和接受缓冲区的大小，16K可存放一个slice，2K存放其他消息
...
typedef struct _Peer {
	...
	int msg_copy_len;				//缓冲区out_msg的长度
	...
	time_t recet_timestamp;				//最近一次发送给peer消息的时间
